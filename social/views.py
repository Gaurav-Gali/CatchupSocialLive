...
from .models import MessageModel, Notification, Post  , Comment, Tag , UserProfile , ThreadModel , Image 
...
class PostListView(LoginRequiredMixin,View):
    ...
    def post(self , request , *args, **kwargs):
        ...
        comments = Comment.objects.filter().order_by('-created_on')
        total = len(comments)
...
class UserSearch(View):
    def get(self , request , *args , **kwargs):
        ...
        context = {
            ...
            'number_of_search_result' : len(profile_list)
        }
...
class CreateThread(View):
    ...
    def post(self , request , *args, **kwargs):
        ...
        try:
            ...
            messages.error(request , 'OOPS ! Search was empty')
